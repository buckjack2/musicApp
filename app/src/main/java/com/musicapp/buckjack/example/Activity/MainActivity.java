package com.musicapp.buckjack.example.Activity;
...
import com.musicapp.buckjack.example.R;
import com.musicapp.buckjack.example.Adapter.RecyclerSingerAdapter;
import com.musicapp.buckjack.example.Model.Singer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerSingerAdapter singerAdapter = new RecyclerSingerAdapter(singer, new RecyclerSingerAdapter.OnItemClickListener() {
            ...
            public void onClickedItemListener(String singerName) {
                Intent intent = new Intent(MainActivity.this, com.musicapp.buckjack.example.Activity.SongsActivity.class);
